        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-24 lg:gap-32">
            ...
            <div class="md:col-span-4 space-y-12">
                ...
                <div class="flex items-center gap-6 pt-4">
                    <a href="#" class="text-gray-500 hover:text-accent-500 transition-all duration-300 transform hover:-translate-y-1">
                ...
                <ul class="space-y-8">
                    <li class="space-y-2">
                        ...
                        <p class="text-[11px] font-bold uppercase tracking-[0.2em] text-gray-400 leading-relaxed">
                            123 LUXE DRIVE, BEVERLY HILLS<br>CALIFORNIA, 90210
                        </p>
                    </li>
                    <li class="space-y-2">
                        <span class="block text-[9px] font-black uppercase tracking-[0.3em] text-gray-600">Inquiries</span>
                        <a href="mailto:concierge@haven.com" class="text-[11px] font-bold uppercase tracking-[0.2em] text-gray-400 hover:text-accent-500 transition-colors">
                            CONCIERGE@HAVEN.COM
                        </a>
                    </li>
                </ul>
            ...
            <div class="md:col-span-3 space-y-10">
                ...
                <div class="space-y-8">
                    <div class="border-l border-white/10 pl-8 space-y-3">
                        <div class="text-2xl font-black text-white">$2.4B<span class="text-accent-500">+</span></div>
                        <div class="text-[9px] font-bold uppercase tracking-[0.3em] text-gray-500">Portfolio Managed</div>
                    </div>
                    <div class="border-l border-white/10 pl-8 space-y-3">
                        <div class="text-2xl font-black text-white">TOP 10</div>
                        <div class="text-[9px] font-bold uppercase tracking-[0.3em] text-gray-500">Global Agency 2024</div>
                    </div>
                </div>
            </div>
        </div>
